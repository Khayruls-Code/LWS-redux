...
import { deleteTodo, selectColor, toggleTodo } from "../redux/todos/actions";
...
export default function Todo({ todo }) {
  ...
  const hangleColorChange = (id, color) => {
  ...
  return (
    <div className="flex justify-start items-center p-2 hover:bg-gray-100 hover:transition-all space-x-4 border-b border-gray-400/20 last:border-0">
      ...
      <div
        onClick={() => hangleColorChange(id, "green")}
      ...
      <div
        onClick={() => hangleColorChange(id, "yellow")}
      ...
      <div
        onClick={() => hangleColorChange(id, "red")}
